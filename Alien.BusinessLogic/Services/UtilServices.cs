...
namespace BusinessLogic.Services
{
    public static class UtilServices
    {
        ...
        {
            return Encriptar(AppConfiguration.ChaveCriptografia, AppConfiguration.VetorInicializacaoCriptografia, textoNormal);
        }
        ...
        public static string Decriptar(string textoNormal)
        {
            return Decriptar(AppConfiguration.ChaveCriptografia, AppConfiguration.VetorInicializacaoCriptografia, textoNormal);
        }
        ...
        //public static string RetornaSenhaBeneficiarioCriptografada(Eficaz_Beneficiario beneficiario)
        //{
        //    var data = beneficiario.Dat_Nascimento_Apresentacao.HasValue ? beneficiario.Dat_Nascimento_Apresentacao.Value.ToString("dd/MM/yyyy").Replace("/", "") : "";
        //    var cpf = beneficiario.Nro_CPF.Replace(".", "").Replace("-", "");
        //    beneficiario.Des_Senha = UtilServices.Encriptar(data + cpf.Substring(0, 3));

        //    return beneficiario.Des_Senha;
        //}
        public static string RetornaNumerosCPF(string NroCPF)
        {
            return NroCPF.Replace("/", "").Replace("-", "").Replace(".", "");
        }
